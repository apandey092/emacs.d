...
(if (boundp 'org-mode-user-lisp-path)
  (add-to-list 'load-path (expand-file-name "~/Dropbox/org")))
...
;; FIX: http://stackoverflow.com/questions/21767471/org-capture-and-time-clocking-misbehaving
(defun bh/remove-empty-drawer-on-clock-out ()
  (interactive)
  (save-excursion
    (beginning-of-line 0)
